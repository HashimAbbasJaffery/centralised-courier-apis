...
<body>
   ...
   <script type="module">
    ...
    const vendor = document.querySelector('.vendor-item');
    vendor.addEventListener('click', (event) => {
  alert(route("vendors.index"));

    // If you want to get the route name from a data attribute
